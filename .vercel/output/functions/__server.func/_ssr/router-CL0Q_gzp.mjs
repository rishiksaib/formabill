...
import { c as isoDate, d as toPaise, f as uid, s as invoiceTotal, t as addFrequency, u as nextInvoiceNumber } from "./utils-DgMi_UEP.mjs";
...
import { $ as encode, $t as queueAfterTransactionHook, A as jwtVerify, At as number, Bt as isSafeUrlScheme, C as serializeSignedCookie, D as decodeJwt, Dt as email, E as base64Url, Et as boolean, Ft as union, Gt as withSpan, Ht as capitalizeFirstLetter, Jt as ATTR_OPERATION_ID, Kt as ATTR_CONTEXT, Mt as optional, Nt as record, O as decodeProtectedHeader, Ot as literal, Pt as string, Qt as getCurrentAdapter, Rt as betterFetch, S as serializeCookie, Tt as array, Ut as toKebabCase, Vt as normalizePathname, Xt as safeJSONParse, Yt as import_src, Zt as getAuthTables, _ as runWithRequestState, _n as APIError, a as createAuthorizationURL, an as generateId, b as createRouter$1, bn as BASE_ERROR_CODES, c as createRateLimitKey, cn as logger, d as deprecate, dn as env, dt as JWTExpired, en as runWithAdapter, f as createAuthEndpoint, g as hasRequestState, gn as isTest, h as defineRequestState, hn as isProduction, i as refreshAccessToken, in as initGetFieldName, jt as object, k as importJWK, kt as looseObject, l as findInvalidTrustedProxies, ln as shouldPublishLog, m as isAPIError, mn as isDevelopment, n as socialProviders, nn as getBetterAuthVersion, o as applyDefaultAccessTokenExpiry, on as createRandomStringGenerator, p as createAuthMiddleware, qt as ATTR_HOOK_TYPE, r as validateAuthorizationCode, rn as initGetModelName, s as isLoopbackHost, sn as createLogger, t as SocialProviderListEnum, tn as runWithTransaction, u as getIp, v as getCurrentAuthContext, vn as BetterAuthError, w as filterOutputFields, wt as any, x as toResponse, xn as defineErrorCodes, y as runWithEndpointContext, yn as kAPIErrorHeaderSymbol, zt as createFetch } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CL0Q_gzp.js
...
*/
var authConfigured$1 = Boolean(void 0);
...
var styles_default = "/assets/styles-CQhhrnZG.css";
...
var $$splitComponentImporter$9 = () => import("./routes-CBNbgSKg.mjs");
var Route$18 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./app-BGPowjr7.mjs");
var Route$17 = createFileRoute("/app")({
	ssr: false,
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./login-C70s6C-o.mjs");
var Route$16 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./privacy-Bi8by1Mc.mjs");
var Route$15 = createFileRoute("/privacy")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./terms-BOCSPIrG.mjs");
var Route$14 = createFileRoute("/terms")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
...
var Route$13 = createFileRoute("/api/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
async function isProUser(userId) {
	const rows = await (await getSql())`select "isPro" from "user" where "id" = ${userId} limit 1`;
...
var Route$12 = createFileRoute("/api/invoices")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireFreeTierRequestUserId();
...
var $$splitComponentImporter$4 = () => import("./app-DU2OkWga.mjs");
var Route$11 = createFileRoute("/app/")({
	validateSearch: (search) => ({ id: typeof search.id === "string" ? search.id : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./clients-DSc8_3aP.mjs");
var Route$10 = createFileRoute("/app/clients")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./invoices-DiuI5ZHL.mjs");
var Route$9 = createFileRoute("/app/invoices")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings-D1HLAQxd.mjs");
...
var $$splitComponentImporter = () => import("./inv._id-_yVAsm6r.mjs");
var Route$7 = createFileRoute("/inv/$id")({
	loader: async ({ params }) => {
...
var Route$5 = createFileRoute("/api/invoices/$id")({ server: { handlers: {
...
var Route$4 = createFileRoute("/api/pro/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
		const userId = await requireFreeTierRequestUserId();
...
var Route$3 = createFileRoute("/api/pro/status")({ server: { handlers: { GET: async ({ request }) => {
...
var Route$2 = createFileRoute("/api/recurring/process")({ server: { handlers: { POST: async ({ request }) => {
	const userId = await requireFreeTierRequestUserId();
...
var Route = createFileRoute("/api/webhooks/razorpay-platform")({ server: { handlers: { POST: async ({ request }) => {
	const raw = await request.text();
...
var ApiCheckoutRoute = Route$13.update({
	id: "/api/checkout",
	path: "/api/checkout",
	getParentRoute: () => Route$19
});
var ApiInvoicesRoute = Route$12.update({
	id: "/api/invoices",
	path: "/api/invoices",
	getParentRoute: () => Route$19
});
...
var AppClientsRoute = Route$10.update({
	id: "/clients",
	path: "/clients",
	getParentRoute: () => AppRoute
});
var AppInvoicesRoute = Route$9.update({
	id: "/invoices",
	path: "/invoices",
	getParentRoute: () => AppRoute
});
...
var ApiInvoicesIdRoute = Route$5.update({
	id: "/$id",
	path: "/$id",
	getParentRoute: () => ApiInvoicesRoute
});
var ApiProCheckoutRoute = Route$4.update({
	id: "/api/pro/checkout",
	path: "/api/pro/checkout",
	getParentRoute: () => Route$19
});
var ApiProStatusRoute = Route$3.update({
	id: "/api/pro/status",
	path: "/api/pro/status",
	getParentRoute: () => Route$19
});
var ApiRecurringProcessRoute = Route$2.update({
...
var ApiWebhooksRazorpayPlatformRoute = Route.update({
...
var rootRouteChildren = {
	...
	TermsRoute,
	ApiCheckoutRoute,
	ApiInvoicesRoute: ApiInvoicesRoute._addFileChildren(ApiInvoicesRouteChildren),
	InvIdRoute,
	ApiAuthSplatRoute,
	ApiProCheckoutRoute,
	ApiProStatusRoute,
...
//#endregion
export { DEFAULT_SETTINGS as a, Route$11 as c, authConfigured$1 as d, emptyLineItem as i, SUPPORT_EMAIL as l, applySettingsToInvoice as n, Route$7 as o, createDraftInvoice as r, Route$8 as s, router_exports as t, authClient as u };
