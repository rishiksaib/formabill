...
*   when this is false.
*/
var Route$23 = createFileRoute("/api/auth-status")({ server: { handlers: { GET: ({ request }) => {
...
var Route$22 = createFileRoute("/api/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
*/
function parseLifetimeAllowlist(raw) {
	return new Set((raw ?? "").split(/[,\s]+/).map((entry) => entry.trim().replace(/^["']+|["']+$/g, "").toLowerCase()).filter(Boolean));
}
...
* allowlist contents.
*/
async function getProDebugInfo(userId) {
	const sql = await getSql();
	let raw = null;
	try {
		raw = (await sql`
	...
	return {
		...
		allowlisted: email !== null && parseLifetimeAllowlist(process.env.LIFETIME_PRO_EMAILS).has(email.toLowerCase()),
		plan
	};
}
/**
...
*/
var Route$21 = createFileRoute("/api/gift-codes")({ server: { handlers: {
	GET: async () => {
		try {
...
var Route$20 = createFileRoute("/api/invoices")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireFreeTierRequestUserId();
...
var Route$19 = createFileRoute("/api/mcp")({ server: { handlers: {
...
var Route$12 = createFileRoute("/api/gift-codes/redeem")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
var Route$11 = createFileRoute("/api/invoices/$id")({ server: { handlers: {
...
*/
var Route$10 = createFileRoute("/api/mcp/tokens")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireRequestUserId();
...
var Route$9 = createFileRoute("/api/pro/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
		const userId = await requireRequestUserId();
		const body = await request.json().catch(() => ({}));
...
*/
var Route$8 = createFileRoute("/api/pro/debug")({ server: { handlers: { GET: async () => {
	try {
		const userId = await requireRequestUserId();
		return Response.json(await getProDebugInfo(userId));
	} catch (error) {
		if (error instanceof UnauthorizedError) return Response.json({ error: "Sign in to inspect Pro state." }, { status: 401 });
		return Response.json({ error: error instanceof Error ? error.message : "Could not load Pro state" }, { status: 400 });
	}
} } } });
...
var TermsRoute = Route$24.update({
	id: "/terms",
	path: "/terms",
	getParentRoute: () => Route$31
});
var ApiAuthStatusRoute = Route$23.update({
	id: "/api/auth-status",
	path: "/api/auth-status",
	getParentRoute: () => Route$31
});
var ApiCheckoutRoute = Route$22.update({
	id: "/api/checkout",
	path: "/api/checkout",
	getParentRoute: () => Route$31
});
var ApiGiftCodesRoute = Route$21.update({
	id: "/api/gift-codes",
	path: "/api/gift-codes",
	getParentRoute: () => Route$31
});
var ApiInvoicesRoute = Route$20.update({
	id: "/api/invoices",
	path: "/api/invoices",
	getParentRoute: () => Route$31
});
var ApiMcpRoute = Route$19.update({
	id: "/api/mcp",
	path: "/api/mcp",
	getParentRoute: () => Route$31
});
...
var AppClientsRoute = Route$17.update({
	id: "/clients",
	path: "/clients",
	getParentRoute: () => AppRoute
});
var AppInvoicesRoute = Route$16.update({
	id: "/invoices",
	path: "/invoices",
	getParentRoute: () => AppRoute
});
...
var InvIdRoute = Route$14.update({
	id: "/inv/$id",
	path: "/inv/$id",
	getParentRoute: () => Route$31
});
...
var ApiGiftCodesRedeemRoute = Route$12.update({
	id: "/redeem",
	path: "/redeem",
	getParentRoute: () => ApiGiftCodesRoute
});
var ApiInvoicesIdRoute = Route$11.update({
	id: "/$id",
	path: "/$id",
	getParentRoute: () => ApiInvoicesRoute
});
var ApiMcpTokensRoute = Route$10.update({
	id: "/tokens",
	path: "/tokens",
	getParentRoute: () => ApiMcpRoute
});
var ApiProCheckoutRoute = Route$9.update({
	id: "/api/pro/checkout",
	path: "/api/pro/checkout",
	getParentRoute: () => Route$31
});
var ApiProDebugRoute = Route$8.update({
	id: "/api/pro/debug",
	path: "/api/pro/debug",
	getParentRoute: () => Route$31
});
...
//#endregion
export { sendPasswordResetEmail as _, applySettingsToInvoice as a, GROK_PROVIDERS as c, getBaseURL as d, SUPPORT_EMAIL as f, Route$18 as i, GENERIC_OAUTH_ERROR_CODES as l, DEFAULT_SETTINGS as m, Route$14 as n, createDraftInvoice as o, Route$25 as p, Route$15 as r, emptyLineItem as s, router_exports as t, PACKAGE_VERSION as u };
