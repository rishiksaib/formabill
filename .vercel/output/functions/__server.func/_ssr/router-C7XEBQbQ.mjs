...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-C7XEBQbQ.js
...
var Route$28 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./app-GykXFt87.mjs");
var Route$27 = createFileRoute("/app")({
	ssr: false,
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("./forgot-password-Bfa134XF.mjs");
var Route$26 = createFileRoute("/forgot-password")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./login-8gWFQcoz.mjs");
var Route$25 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./privacy-BTnvGkzl.mjs");
var Route$24 = createFileRoute("/privacy")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./reset-password-CJmaVcUn.mjs");
...
var $$splitComponentImporter$5 = () => import("./terms-VoeOBGq3.mjs");
var Route$22 = createFileRoute("/terms")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
...
var auth = betterAuth({
	...
	emailAndPassword: {
		...
		sendResetPassword: async ({ user, url }) => {
			const { sendPasswordResetEmail } = await import("./mailer.server-DGjsTj5G.mjs");
...
*   when this is false.
*/
var Route$21 = createFileRoute("/api/auth-status")({ server: { handlers: { GET: ({ request }) => {
...
var Route$20 = createFileRoute("/api/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
*/
var Route$19 = createFileRoute("/api/gift-codes")({ server: { handlers: {
	GET: async () => {
		try {
...
var Route$18 = createFileRoute("/api/invoices")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireFreeTierRequestUserId();
...
var Route$17 = createFileRoute("/api/mcp")({ server: { handlers: {
...
var $$splitComponentImporter$4 = () => import("./app-ZOrsEEjn.mjs");
var Route$16 = createFileRoute("/app/")({
	validateSearch: (search) => ({ id: typeof search.id === "string" ? search.id : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./clients-CCAK0R20.mjs");
var Route$15 = createFileRoute("/app/clients")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./invoices-0lvuLK3n.mjs");
var Route$14 = createFileRoute("/app/invoices")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings-DjKJmJ1v.mjs");
...
var $$splitComponentImporter = () => import("./inv._id-BZmt9Mxq.mjs");
var Route$12 = createFileRoute("/inv/$id")({
	loader: async ({ params }) => {
...
var Route$10 = createFileRoute("/api/gift-codes/redeem")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
var Route$9 = createFileRoute("/api/invoices/$id")({ server: { handlers: {
...
*/
var Route$8 = createFileRoute("/api/mcp/tokens")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireRequestUserId();
...
async function createPlatformProCheckout(userId, request, plan = "pro_monthly") {
...
var Route$7 = createFileRoute("/api/pro/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
		const userId = await requireRequestUserId();
		const body = await request.json().catch(() => ({}));
		const checkout = await createPlatformProCheckout(userId, request, isProPlan(body.plan) ? body.plan : "pro_monthly");
...
var Route$6 = createFileRoute("/api/pro/status")({ server: { handlers: { GET: async ({ request }) => {
...
var Route$1 = createFileRoute("/api/webhooks/razorpay-platform")({ server: { handlers: { POST: async ({ request }) => {
	...
	if (event.event !== "payment_link.paid") return Response.json({
		ok: true,
		ignored: event.event
	});
	const notes = event.payload?.payment_link?.entity?.notes;
	if (!notes?.userId || notes.plan !== "pro_monthly" && notes.plan !== "pro_yearly") return Response.json({ error: "Missing Pro checkout metadata" }, { status: 400 });
...
var ApiAuthStatusRoute = Route$21.update({
	id: "/api/auth-status",
	path: "/api/auth-status",
	getParentRoute: () => Route$29
});
var ApiCheckoutRoute = Route$20.update({
	id: "/api/checkout",
	path: "/api/checkout",
	getParentRoute: () => Route$29
});
var ApiGiftCodesRoute = Route$19.update({
	id: "/api/gift-codes",
	path: "/api/gift-codes",
	getParentRoute: () => Route$29
});
var ApiInvoicesRoute = Route$18.update({
	id: "/api/invoices",
	path: "/api/invoices",
	getParentRoute: () => Route$29
});
var ApiMcpRoute = Route$17.update({
	id: "/api/mcp",
	path: "/api/mcp",
	getParentRoute: () => Route$29
});
...
var AppClientsRoute = Route$15.update({
	id: "/clients",
	path: "/clients",
	getParentRoute: () => AppRoute
});
var AppInvoicesRoute = Route$14.update({
	id: "/invoices",
	path: "/invoices",
	getParentRoute: () => AppRoute
});
...
var InvIdRoute = Route$12.update({
	id: "/inv/$id",
	path: "/inv/$id",
	getParentRoute: () => Route$29
});
var ApiAuthSplatRoute = Route$11.update({
	id: "/api/auth/$",
	path: "/api/auth/$",
	getParentRoute: () => Route$29
});
var ApiGiftCodesRedeemRoute = Route$10.update({
	id: "/redeem",
	path: "/redeem",
	getParentRoute: () => ApiGiftCodesRoute
});
var ApiInvoicesIdRoute = Route$9.update({
	id: "/$id",
	path: "/$id",
	getParentRoute: () => ApiInvoicesRoute
});
var ApiMcpTokensRoute = Route$8.update({
	id: "/tokens",
	path: "/tokens",
	getParentRoute: () => ApiMcpRoute
});
var ApiProCheckoutRoute = Route$7.update({
	id: "/api/pro/checkout",
	path: "/api/pro/checkout",
	getParentRoute: () => Route$29
});
var ApiProStatusRoute = Route$6.update({
	id: "/api/pro/status",
	path: "/api/pro/status",
	getParentRoute: () => Route$29
});
...
//#endregion
export { sendPasswordResetEmail as _, applySettingsToInvoice as a, GROK_PROVIDERS as c, getBaseURL as d, SUPPORT_EMAIL as f, Route$16 as i, GENERIC_OAUTH_ERROR_CODES as l, DEFAULT_SETTINGS as m, Route$12 as n, createDraftInvoice as o, Route$23 as p, Route$13 as r, emptyLineItem as s, router_exports as t, PACKAGE_VERSION as u };
