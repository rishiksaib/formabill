...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DLqJfHSy.mjs");
...
var manifest = { "7cf99f1f443df70951f16026984e7f7a664d02eb63efa6624ccde1f1d6e46144": {
	functionName: "getPublicInvoice_createServerFn_handler",
	importer: () => import("./invoice.functions-DllcQmrr.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BozvWNW5.mjs").then((n) => n.t),
