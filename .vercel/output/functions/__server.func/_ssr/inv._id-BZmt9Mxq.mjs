...
import { n as Route$12 } from "./router-C7XEBQbQ.mjs";
import { t as InvoiceDocument } from "./document-lgfe_FuB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/inv._id-BZmt9Mxq.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function PublicInvoicePage() {
	const { invoice: initial } = Route$12.useLoaderData();
