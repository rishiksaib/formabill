...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CP-Z3rz-.js
...
var styles_default = "/assets/styles-0-XbveTt.css";
...
var $$splitComponentImporter$9 = () => import("./routes-DHPKPTat.mjs");
var Route$15 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./app-CC3DAhFC.mjs");
var Route$14 = createFileRoute("/app")({
	ssr: false,
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./login-yf1GJ6f8.mjs");
var Route$13 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./privacy-wmc6bj7A.mjs");
var Route$12 = createFileRoute("/privacy")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./terms-DRjnH6tq.mjs");
var Route$11 = createFileRoute("/terms")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
function env$2(key) {
...
async function requireRequestUserId(request) {
	const userId = await getRequestUserId(request);
	if (!userId) throw new Error("Sign in required to manage invoices.");
	return userId;
}
var Route$10 = createFileRoute("/api/checkout")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		return Response.json({ error: err instanceof Error ? err.message : "Checkout failed" }, { status: err instanceof Error && err.message.includes("Sign in required") ? 401 : 400 });
	}
} } } });
...
var Route$9 = createFileRoute("/api/invoices")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
			const userId = await requireRequestUserId(request);
	...
	POST: async ({ request }) => {
		try {
			...
			const existing = await getInvoice(body.id, userId ?? void 0);
			if (existing?.userId && !userId) return Response.json({ error: "Sign in required to update this invoice." }, { status: 401 });
...
var $$splitComponentImporter$4 = () => import("./app-DcxtAHfu.mjs");
var Route$8 = createFileRoute("/app/")({
	validateSearch: (search) => ({ id: typeof search.id === "string" ? search.id : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./clients-DLUYMdGh.mjs");
var Route$7 = createFileRoute("/app/clients")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./invoices-Cp881avT.mjs");
var Route$6 = createFileRoute("/app/invoices")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings-DK9JIjNN.mjs");
var Route$5 = createFileRoute("/app/settings")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
...
var $$splitComponentImporter = () => import("./inv._id-vELNFmba.mjs");
var Route$4 = createFileRoute("/inv/$id")({
	loader: async ({ params }) => {
...
var Route$2 = createFileRoute("/api/invoices/$id")({ server: { handlers: {
	...
	PUT: async ({ params, request }) => {
		try {
			const userId = await getRequestUserId(request);
			const existing = await getInvoice(params.id, userId ?? void 0);
			if (existing?.userId && !userId) return Response.json({ error: "Sign in required to update this invoice." }, { status: 401 });
			const body = await request.json();
			const merged = {
				...existing ?? body,
			...
			const saved = await upsertInvoice(merged, userId ?? void 0);
			return Response.json(saved);
		} catch (err) {
...
var Route$1 = createFileRoute("/api/recurring/process")({ server: { handlers: { POST: async ({ request }) => {
	const userId = await requireRequestUserId(request);
...
var Route = createFileRoute("/api/webhooks/razorpay")({ server: { handlers: { POST: async ({ request }) => {
...
var ApiCheckoutRoute = Route$10.update({
	id: "/api/checkout",
	path: "/api/checkout",
	getParentRoute: () => Route$16
});
var ApiInvoicesRoute = Route$9.update({
	id: "/api/invoices",
	path: "/api/invoices",
	getParentRoute: () => Route$16
});
...
var AppClientsRoute = Route$7.update({
	id: "/clients",
	path: "/clients",
	getParentRoute: () => AppRoute
});
var AppInvoicesRoute = Route$6.update({
	id: "/invoices",
	path: "/invoices",
	getParentRoute: () => AppRoute
});
...
var ApiInvoicesIdRoute = Route$2.update({
	id: "/$id",
	path: "/$id",
	getParentRoute: () => ApiInvoicesRoute
});
var ApiRecurringProcessRoute = Route$1.update({
	id: "/api/recurring/process",
	path: "/api/recurring/process",
	getParentRoute: () => Route$16
});
var ApiWebhooksRazorpayRoute = Route.update({
...
//#endregion
export { DEFAULT_SETTINGS as a, authClient as c, emptyLineItem as i, applySettingsToInvoice as n, Route$4 as o, createDraftInvoice as r, Route$8 as s, router_exports as t };
