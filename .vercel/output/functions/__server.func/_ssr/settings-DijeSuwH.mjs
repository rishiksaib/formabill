...
import { r as Route$14 } from "./router-C0U3mc95.mjs";
...
import { r as signOut } from "./client-hwQiLbhx.mjs";
import { t as useCurrentUserState } from "./use-current-user-BoG-If-8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-DijeSuwH.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function SettingsPage() {
	const { ready, settings, saveSettings } = useStore();
	const { pro: proReturn } = Route$14.useSearch();
...
function GiftSection({ isPro, signedIn, codes, canGift, giftsRemaining, proSource, grantLabel, fresh, onDismissFresh, busy, onGenerate, redeemCode, onRedeemCodeChange, redeemBusy, onRedeem, onCopy }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SectionCard, {
		kicker: "Gift codes",
		...
		children: [signedIn && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			isPro && !canGift ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-lg border border-dashed border-border bg-secondary/40 p-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm font-medium",
			...
			isPro && canGift ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "text-sm text-muted-foreground",
				children: [
					giftsRemaining,
					" gift code",
			...
			canGift ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-4 flex flex-wrap items-center gap-3 rounded-lg border border-border p-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "min-w-0 flex-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm font-medium",
