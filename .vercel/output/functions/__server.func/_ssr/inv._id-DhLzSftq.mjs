...
import { n as Route$13 } from "./router-47USl1IM.mjs";
import { t as InvoiceDocument } from "./document-lgfe_FuB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/inv._id-DhLzSftq.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function PublicInvoicePage() {
	const { invoice: initial } = Route$13.useLoaderData();
