...
import { _ as ArrowUpRight, c as LoaderCircle, f as FileQuestion, g as Copy, l as Link2, m as Download } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { o as Route$7 } from "./router-CL0Q_gzp.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/inv._id-_yVAsm6r.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function PublicInvoicePage() {
	const { invoice: initial } = Route$7.useLoaderData();
	...
	if (!invoice) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-dvh flex-col items-center justify-center bg-slate-50 px-6 py-12 text-center",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { to: "/" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-8 w-full max-w-sm rounded-2xl border border-border bg-white p-8 shadow-sm",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileQuestion, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "This link may not have been published yet. Ask the sender to tap Save or Copy link and share the fresh URL — or check for typos."
				}),
	...
	const isInr = (invoice.currency || "USD") === "INR";
	...
	const upiLink = isInr && upiId ? `upi://pay?pa=${encodeURIComponent(upiId).replace(/%40/gi, "@")}\u0026${upiQuery.toString()}` : "";
	const copyUpi = async () => {
		if (!upiId) return;
		try {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											children: paid ? "Amount paid" : "Amount due"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						!paid && isInr && upiId ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						!paid && !isInr && upiId ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-4 rounded-xl border border-dashed border-amber-200 bg-amber-50 p-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[10px] uppercase tracking-[0.14em] text-amber-700",
								children: "UPI unavailable"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1 text-sm text-amber-900",
								children: "UPI is available for INR invoices only."
							})]
						}) : null,
				...
				!paid ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link2, { className: "mr-1 size-3.5" }), "Copy link"]
					})]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 text-center text-sm text-emerald-700 font-medium",
