...
import { p as Route$23 } from "./router-C7XEBQbQ.mjs";
import { t as authClient } from "./client-DpPrbCFe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/reset-password-CJmaVcUn.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ResetPasswordPage() {
	const { token } = Route$23.useSearch();
