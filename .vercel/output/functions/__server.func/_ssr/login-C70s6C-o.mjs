...
import { d as authConfigured$1, u as authClient } from "./router-CL0Q_gzp.mjs";
import { t as Button } from "./button-CYO0UllO.mjs";
import { n as Label, t as Input } from "./label-DNloEtcu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-C70s6C-o.js
...
function LoginPage() {
	...
	if (!authConfigured$1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoginWaitlist, {});
